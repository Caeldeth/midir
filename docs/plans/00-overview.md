...
WP13 (the action layer: window, keys, the stop)   COMPLETE — complete/13-action-layer.md
 ...
 └── WP15 (Walker)   COMPLETE — complete/15-walker.md
      └── WP17 (Laborer)   COMPLETE — complete/17-clout-assistant.md — sixteen errands, proven live
           ...
           ├── WP34 (dismiss blocking popups)   IN PROGRESS — built; the live check is left
...
WP34 (dismiss blocking popups)   IN PROGRESS — built on 2026-09-21; the live check is left
...
| WP34 | S    | Dismiss blocking popups         | HTOO-83  | IN PROGRESS — `34-dismiss-blocking-popups.md`    |
